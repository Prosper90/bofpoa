...
import mkt from "../../img/mkt1500.png";
...
<div
  ...
  aria-label="Slider"
>
  <div id="n2-ss-23-align" className="n2-ss-align n2-ss-align-visible">
          ...
          <div className="n2-ss-slider-2 n2-ow">
            ...
            <div className="n2-ss-slider-3 n2-ow">
              ...
              <div
                ...
                data-title="Slide 3"
                className="n2-ss-slide n2-ow n2-ss-slide-38 n2-ss-slide-active"
              ...
              >
                ...
                <div className="n2-ss-layers-container n2-ss-slide-limiter n2-ow">
                  <div
                    className="n2-ss-layer n2-ow n-uc-U7LYnw9wodXX"
                    data-sstype="slide"
                    data-pm="default"
                    style={{ perspective: 1000 }}
                  >
                    <div
                      className="n2-ss-layer n2-ow n-uc-OJNrLoTG5O61"
                      data-pm="default"
                      data-sstype="content"
                      data-hasbackground={0}
                    >
                      <div
                        className="n2-ss-section-main-content n2-ss-layer-with-background n2-ss-layer-content n2-ow n-uc-OJNrLoTG5O61-inner"
                        style={{ perspective: 1000 }}
                      >
                        <div
                          className="n2-ss-layer n2-ow n2-ss-layer--block n2-ss-has-self-align n-uc-nGRTXzcy5YwQ"
                          data-pm="normal"
                          data-sstype="row"
                        >
                          <div className="n2-ss-layer-row n2-ss-layer-with-background n-uc-nGRTXzcy5YwQ-inner">
                            <div
                              className="n2-ss-layer-row-inner "
                              style={{ perspective: 1000 }}
                            >
                              <div
                                className="n2-ss-layer n2-ow n-uc-dTy7f6Uz6VCm"
                                data-pm="default"
                                data-sstype="col"
                              >
                                <div
                                  className="n2-ss-layer-col n2-ss-layer-with-background n2-ss-layer-content n-uc-dTy7f6Uz6VCm-inner"
                                  style={{ perspective: 1000 }}
                                >
                                  <div
                                    className="n2-ss-layer n2-ow n-uc-1a89db0276c70"
                                    data-pm="normal"
                                  ...
                                  <div
                                    className="n2-ss-layer n2-ow n-uc-v5aOzvHnNHsA"
                                    data-pm="normal"
                                    data-sstype="layer"
                                  >
                                    <div
                                  ...
                                  <div
                                    className="n2-ss-layer n2-ow n-uc-29hLwcBaFBUZ"
                                    data-pm="normal"
                                    data-sstype="layer"
                                  >
                                    <div
                                  ...
                                  <div
                                    className="n2-ss-layer n2-ow n-uc-mXZ0ZBTjRC1w"
                                    data-pm="normal"
                                    data-sstype="layer"
                                  >
                                    <div
                                      ...
                                      style={{ display: "block" }}
                                    >
                                      $BANK has a wide range of marketing
                                      services available through the connections
                                      that our main developer has built over
                                      several years in the space. We provide
                                      only efficient and effective marketing at
                                      the lowest cost possible.
                                    </div>
                                  </div>
                                  <div
                                    className="n2-ss-layer n2-ow n-uc-17aa59008e3aa"
                                    data-pm="normal"
                                  ...
                                  >
                                    <div className="n2-ss-button-container n2-ss-item-content n2-ow n2-font-ba5ca255ca313fbd089eaa0091c40c9a-link  n2-ss-nowrap">
                                      ...
                                      >
                                        <div>
                                          <div>For Marketing Inquiries</div>
                                        </div>
                                      </a>
                                    </div>
                                  </div>
                              ...
                              <div
                                className="n2-ss-layer n2-ow n-uc-W80VnsUqx7c8"
                                data-pm="default"
                                data-hidemobileportrait={1}
                                data-sstype="col"
                              >
                                <div
                                  className="n2-ss-layer-col n2-ss-layer-with-background n2-ss-layer-content n-uc-W80VnsUqx7c8-inner"
                                  style={{ perspective: 1000 }}
                                >
                                  <div
                                    className="n2-ss-layer n2-ow n-uc-5VRWJZUIqO3T"
                                    data-pm="normal"
                                    data-animv2='{"basic":{"in":{"type":"basic","name":"Downscale","keyFrames":[{"opacity":0,"scaleX":2,"scaleY":2}]},"loop":{"type":"basic","name":"Pulse","keyFrames":[{"duration":2,"ease":"easeInOutSine","scaleX":1.05,"scaleY":1.05}]}}}'
                                    data-sstype="layer"
                                    style={{
