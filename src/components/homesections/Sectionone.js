                            ...
                            <div className="n2-ss-layer-row n2-ss-layer-with-background n-uc-18f5dfc7da9d3-inner">
                                ...
                                {/* overall container */}
                                 ...
                                 <div className="row gy-3">
                                    ...
                                    <div className="col-12 bg-sectionone">

                                        <div className="tablehead w-100 d-flex justify-content-between">
                                            
                                           <button className="btn btn-success my-2 my-sm-0 editedbutton" >Create New Lock</button>
                                        ...
                                        <div className="tablecontainer" >
                                            ...
                                            <thead className='thead'>
                                                ...
                                                <tbody className='gy-2'>
                                                    <tr className='trfixtwo' >
                                                        <td scope="col">
                                                            <div className="">Sym</div>
                                                            <small>name</small>
                                                        </td>
                                                        <td className='d-flex gx-1' scope="col">
                                    ...
                                    <div className="col-12 bg-sectiontwo">
                                       ...
                                       <div className="bg-sectionthree">

                                        <div className="row">

                                           <div className="d-flex flex-column align-items-start gy-4 col-8">
                                              <h3 className='w-50'>CREATE A CUSTOM LOCKUP NOW</h3>
